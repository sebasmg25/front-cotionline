...
export const COLOMBIAN_DATA: Record<string, string[]> = {
  ...
  'Antioquia': [
    ...
    'Carolina', 'Caucasia', 'Chigorodó', 'Cisneros', 'Ciudad Bolívar',
    ...
    'San Vicente', 'Santa Bárbara', 'Santa Rosa de Osos', 'Santo Domingo',
  ...
  'Boyacá': [
    ...
    'Chitaraque', 'Chivatá', 'Chíquiza', 'Ciénega', 'Cómbita', 'Coper',
    'Corrales', 'Covarachía', 'Cubará', 'Cucaita', 'Cuítiva', 'Duitama',
    'El Cocuy', 'El Espino', 'Firavitoba', 'Floresta', 'Gachantivá', 'Gámeza',
    'Garagoa', 'Guacamayas', 'Guateque', 'Guayatá', 'Güicán de la Sierra',
    'Iza', 'Jenesano', 'Jericó', 'La Capilla', 'La Uvita', 'La Victoria',
    'Labranzagrande', 'Leiva', 'Macanal', 'Maripí', 'Miraflores', 'Mongua',
    ...
    'Sativanorte', 'Sativasur', 'Siachoque', 'Soatá', 'Socha', 'Sogamoso',
    'Somondoco', 'Sora', 'Sotaquirá', 'Susacón', 'Sutamarchán', 'Sutatenza',
    'Tasco', 'Tenza', 'Tibaná', 'Tinjacá', 'Tipacoque', 'Toca', 'Tópaga',
    'Tota', 'Turmequé', 'Tutazá', 'Umbita', 'Ventaquemada', 'Villa de Leyva',
    'Viracachá', 'Yondó', 'Zetaquira'
  ],
  'Caldas': [
    'Manizales', 'Aguadas', 'Anserma', 'Aranzazu', 'Belalcázar', 'Chinchiná',
    'Filadelfia', 'La Dorada', 'La Merced', 'La Victoria', 'Manzanares',
    'Marmato', 'Marquetalia', 'Marulanda', 'Neira', 'Norcasia', 'Pácora',
    'Palestina', 'Pensilvania', 'Riosucio', 'Risaralda', 'Salamina', 'Samaná',
    'San José', 'Supía', 'Victoria', 'Villamaría', 'Viterbo', 'Belén de Umbría',
    'Mistrató'
  ],
  'Caquetá': [
  ...
  'Cauca': [
    ...
    'Patía', 'Piamonte', 'Piendamó-Tunía', 'Puerto Tejada', 'Puracé', 'Rosas',
    'San Sebastián', 'Santander de Quilichao', 'Santa Rosa', 'Silvia', 'Sotara',
    'Suárez', 'Sucre', 'Timbío', 'Timbiquí', 'Toribío', 'Totoro', 'Villa Rica'
  ],
  'Cesar': [
    'Valledupar', 'Aguachica', 'Astrea', 'Becerril', 'Bosconia', 'Chimichagua',
    'Chiriguaná', 'Curumaní', 'El Copey', 'El Paso', 'Gamarra', 'González',
    'La Gloria', 'La Jagua de Ibirico', 'Manaure Balcón del Cesar', 'Pailitas',
  ...
  'Chocó': [
    ...
    'Bajo Baudó', 'Bojayá', 'Carmen del Darién', 'Certeguí', 'Condoto',
  ...
  'Córdoba': [
    ...
    'San Carlos', 'San Pelayo', 'Tierralta', 'Tuchín', 'Valencia'
  ],
  'Cundinamarca': [
    ...
    'Choachí', 'Chocontá', 'Cogua', 'Cota', 'Cucunubá', 'El Colegio', 'El Peñón',
    ...
    'Tibirita', 'Tocaima', 'Tocancipá', 'Topaipí', 'Ubalá', 'Ubaque', 'Une',
    'Útica', 'Vianí', 'Villagómez', 'Villapinzón', 'Villeta', 'Viotá', 'Yacopí',
    'Zipacón', 'Zipaquirá'
  ],
  'Guainía': [
  ...
  'Huila': [
    ...
    'Hobo', 'Iquira', 'Isnos', 'La Argentina', 'La Plata', 'Nátaga', 'Oporapa',
    'Paicol', 'Palestina', 'Pital', 'Pitalito', 'Rivera', 'Saladoblanco',
  ...
  'Magdalena': [
    ...
    'Fundación', 'Guamal', 'Nueva Granada', 'Pedraza', 'Pivijay', 'Plato',
    'Pueblo Viejo', 'Remolino', 'Salamina', 'San Sebastián de Buenavista',
    'San Zenón', 'Santa Ana', 'Sitionuevo', 'Tenerife', 'Zapayán', 'Zona Bananera'
  ],
  'Meta': [
    'Villavicencio', 'Acacías', 'Barranca de Upía', 'Cabuyaro',
    'Castilla la Nueva', 'Cubarral', 'Cumaral', 'El Calvario', 'El Castillo',
    'El Dorado', 'Fuente de Oro', 'Granada', 'Guamal', 'Lejanías', 'Mapiripán',
  ...
  'Nariño': [
    ...
    'Policarpa', 'Potosí', 'Puerres', 'Pupiales', 'Ricaurte', 'Roberto Payán',
  ...
  'Norte de Santander': [
    'Cúcuta', 'Abrego', 'Arboledas', 'Bochalema', 'Bucarasica', 'Cácota',
    'Cachirá', 'Chinácota', 'Chitagá', 'Convención', 'Cucutilla', 'Durania',
    'El Carmen', 'El Tarra', 'El Zulia', 'Gramalote', 'Hacarí', 'Herrán',
    'La Esperanza', 'La Playa de Belén', 'Labateca', 'Lourdes', 'Mutiscua',
  ...
  'Putumayo': [
    ...
    'Puerto Leguízamo', 'Sibundoy', 'San Francisco', 'San Miguel', 'Santiago',
  ...
  'San Andrés y Providencia': [
    'San Andrés', 'Providencia y Santa Catalina Islas'
  ],
  'Santander': [
    ...
    'Gambita', 'Girón', 'Guaca', 'Guadalupe', 'Guapotá', 'Guavatá', 'Güepsa',
  ...
  'Tolima': [
    ...
    'Planas', 'Prado', 'Purificación', 'Rioblanco', 'Roncesvalles', 'Rovira',
    'Saldaña', 'San Antonio', 'San Luis', 'Santa Isabel', 'Suarez', 'Valle de San Juan',
    'Venadillo', 'Villahermosa', 'Villarrica'
  ],
  'Valle del Cauca': [
    'Cali', 'Alcalá', 'Andalucía', 'Ansermanuevo', 'Argelia', 'Bolívar',
    'Buenaventura', 'Buga', 'Bugalagrande', 'Caicedonia', 'Calima (Darién)',
    'Candelaria', 'Cartago', 'Dagua', 'El Cairo', 'El Cerrito', 'El Dovio',
...
export const DEPARTMENTS: string[] = Object.keys(COLOMBIAN_DATA);
